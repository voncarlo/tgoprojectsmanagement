...
export const users: User[] = [
  { id: "u1", name: "James Steffan",    email: "james@tgo.com",   role: "Super Admin", team: "projects",    teams: ["dispatch","recruitment","sales","clients","projects","payroll","bookkeeping"], modules: ALL_MODULES, status: "Active", initials: "JS", lastActive: "Just now" },
  { id: "u2", name: "Ryan Lopez",       email: "ryan@tgo.com",    role: "Manager",     team: "dispatch",    teams: ["dispatch","bookkeeping"], modules: [...STAFF_MODULES, "automations", "dispatch", "bookkeeping"], status: "Active", initials: "RL", lastActive: "12m ago" },
  { id: "u3", name: "Von Carlo Asinas", email: "von@tgo.com",     role: "Manager",     team: "sales",       teams: ["sales","clients"], modules: [...STAFF_MODULES, "automations", "sales", "clients"], status: "Active", initials: "VA", lastActive: "1h ago" },
...
export const projects: Project[] = [
  ...
  { id: "p3", name: "Hiring Sprint — Engineering",  description: "Hire 12 engineers across backend & infra.",       team: "recruitment", owner: "Alyanna Alonzo",   status: "Active",    progress: 58,  start: "2025-03-01", end: "2025-05-15", milestones: [{ name: "Sourcing", done: true }, { name: "Interviews", done: true }, { name: "Offers", done: false }] },
