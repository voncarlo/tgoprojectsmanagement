                ...
                thread.map((entry) => {
                  ...
                  return (
                    <div key={entry.id} className={cn("flex", mine ? "justify-end" : "justify-start")}>
                      <div className={cn("max-w-[78%] rounded-2xl px-4 py-3 text-sm", mine ? "bg-primary text-primary-foreground" : "bg-muted")}>
                        <p>{entry.body}</p>
                        <p className={cn("mt-2 text-[11px]", mine ? "text-primary-foreground/80" : "text-muted-foreground")}>
