...
export const seedProjects = [
  ...
  { id: "p7", name: "Portal Rollout", description: "Cross-team rollout of TGO Projects Portal.", team: "projects", owner: "Von Carlo Asinas", status: "Active", progress: 64, start: "2025-03-20", end: "2025-06-10", milestones: [{ name: "Build", done: true }, { name: "Pilot", done: false }, { name: "Launch", done: false }] },
